 ...
 */
export async function comboboxCreate(page, label, value) {
 ...
 */
export function dateField(page, nth) {
    return page.locator('input[placeholder="ДД.ММ.ГГГГ"]').nth(nth);
}
/**
 * Заполнение input в grid layout
 */
export async function fillGridInput(page, nthChild, value) {
 ...
 */
export async function fillEmployeeForm(page, emp) {
