<%
import os, re as _re
_script_loc = context.config.get_main_option("script_location", "alembic")
_versions_dir = context.config.get_main_option("version_locations") or os.path.join(_script_loc, "versions")
