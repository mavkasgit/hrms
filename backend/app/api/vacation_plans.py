...
async def import_vacation_plans(
    ...
    if not preview_only:
        ...
        # Save the uploaded file as a document via the unified Document model
        from datetime import datetime
        from pathlib import Path
        from app.models.document import Document

        documents_dir = Path(settings.STAFFING_PATH) / "vacation_calendar"
        ...
        relative_path = file_path.relative_to(Path(settings.STAFFING_PATH)).as_posix()
