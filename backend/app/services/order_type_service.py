...
DEFAULT_ORDER_TYPES: list[dict[str, Any]] = [
    {
        ...
        "field_schema": [
            {"key": "hire_date", "label": "Дата приема", "type": "date", "required": False, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "contract_end", "label": "Конец контракта", "type": "date", "required": False, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "new_contract_number", "label": "Номер контракта", "type": "text", "required": False, "enabled": True, "col": 0, "row": 1, "width": 250},
            {"key": "trial_end", "label": "Конец испытательного срока", "type": "date", "required": False, "enabled": True, "col": 1, "row": 1, "width": 130},
        ],
    ...
    },
    {
        ...
        "field_schema": [
            {"key": "dismissal_date", "label": "Дата увольнения", "type": "date", "required": False, "enabled": True, "col": 0, "row": 0, "width": 130},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            {"key": "new_contract_start", "label": "Дата начала нового контракта", "type": "date", "required": False, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "new_contract_end", "label": "Новая дата конца контракта", "type": "date", "required": False, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "new_contract_number", "label": "Номер нового контракта", "type": "text", "required": False, "enabled": True, "col": 0, "row": 1, "width": 250},
            {"key": "new_contract_years", "label": "Срок контракта (лет)", "type": "number", "required": False, "enabled": True, "col": 1, "row": 1, "width": 100},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            {"key": "old_contract_start", "label": "Дата начала предыдущего контракта", "type": "date", "required": False, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "old_contract_end", "label": "Дата окончания предыдущего контракта", "type": "date", "required": False, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "old_contract_number", "label": "Номер предыдущего контракта", "type": "text", "required": False, "enabled": True, "col": 0, "row": 1, "width": 250},
            {"key": "new_contract_start", "label": "Дата начала нового контракта", "type": "date", "required": False, "enabled": True, "col": 1, "row": 1, "width": 130},
            {"key": "new_contract_end", "label": "Новая дата конца контракта", "type": "date", "required": False, "enabled": True, "col": 0, "row": 2, "width": 130},
            {"key": "new_contract_years", "label": "Срок продления (лет)", "type": "number", "required": False, "enabled": True, "col": 1, "row": 2, "width": 100},
            {"key": "trial_end", "label": "Конец испытательного срока", "type": "date", "required": False, "enabled": True, "col": 0, "row": 3, "width": 130},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            ...
            {"key": "new_contract_start", "label": "Дата начала нового контракта", "type": "date", "required": False, "enabled": True, "col": 1, "row": 1, "width": 130},
            {"key": "new_contract_end", "label": "Новая дата конца контракта", "type": "date", "required": False, "enabled": True, "col": 0, "row": 2, "width": 130},
            {"key": "new_contract_number", "label": "Номер нового контракта", "type": "text", "required": False, "enabled": True, "col": 1, "row": 2, "width": 250},
            {"key": "contract_end_years", "label": "Срок контракта (лет)", "type": "number", "required": False, "enabled": True, "col": 0, "row": 3, "width": 100},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            {"key": "vacation_start", "label": "Дата начала", "type": "date", "required": True, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "vacation_end", "label": "Дата окончания", "type": "date", "required": True, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "vacation_days", "label": "Количество дней", "type": "number", "required": True, "enabled": True, "col": 0, "row": 1, "width": 100},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "л",
    },
    ...
    },
    {
        ...
        "field_schema": [
            {"key": "call_date", "label": "Дата вызова", "type": "date", "required": False, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "call_date_start", "label": "Дата начала", "type": "date", "required": False, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "call_date_end", "label": "Дата окончания", "type": "date", "required": False, "enabled": True, "col": 0, "row": 1, "width": 130},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            {"key": "call_date_start", "label": "Дата начала", "type": "date", "required": True, "enabled": True, "col": 0, "row": 0, "width": 130},
        ],
    ...
    },
    {
        ...
        "field_schema": [
            {"key": "recall_date", "label": "Дата отзыва", "type": "date", "required": True, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "old_vacation_start", "label": "Дата начала отпуска", "type": "date", "required": True, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "old_vacation_end", "label": "Дата окончания отпуска", "type": "date", "required": True, "enabled": True, "col": 0, "row": 1, "width": 130},
            {"key": "old_vacation_days", "label": "Количество дней отпуска", "type": "number", "required": True, "enabled": True, "col": 1, "row": 1, "width": 100},
            {"key": "reason", "label": "Основание", "type": "text", "required": False, "enabled": True, "col": 0, "row": 2, "width": 250},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "л",
    },
    {
        ...
        "field_schema": [
            {"key": "old_vacation_start", "label": "Старая дата начала", "type": "date", "required": True, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "old_vacation_end", "label": "Старая дата окончания", "type": "date", "required": True, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "new_vacation_start", "label": "Новая дата начала", "type": "date", "required": True, "enabled": True, "col": 0, "row": 1, "width": 130},
            {"key": "new_vacation_end", "label": "Новая дата окончания", "type": "date", "required": True, "enabled": True, "col": 1, "row": 1, "width": 130},
            {"key": "vacation_days", "label": "Количество дней", "type": "number", "required": True, "enabled": True, "col": 0, "row": 2, "width": 100},
            {"key": "reason", "label": "Основание", "type": "text", "required": False, "enabled": True, "col": 1, "row": 2, "width": 250},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "л",
    },
    {
        ...
        "field_schema": [
            {"key": "vacation_start", "label": "Дата начала отпуска", "type": "date", "required": True, "enabled": True, "col": 0, "row": 0, "width": 130},
            {"key": "vacation_end", "label": "Дата окончания отпуска", "type": "date", "required": True, "enabled": True, "col": 1, "row": 0, "width": 130},
            {"key": "vacation_days", "label": "Количество дней отпуска", "type": "number", "required": True, "enabled": True, "col": 0, "row": 1, "width": 100},
            {"key": "sick_start_date", "label": "Дата начала больничного", "type": "date", "required": True, "enabled": True, "col": 1, "row": 1, "width": 130},
            {"key": "sick_end_date", "label": "Дата окончания больничного", "type": "date", "required": True, "enabled": True, "col": 0, "row": 2, "width": 130},
            {"key": "comment", "label": "Комментарий", "type": "text", "required": False, "enabled": True, "col": 1, "row": 2, "width": 250},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "л",
    },
