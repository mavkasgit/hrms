...
DEFAULT_ORDER_TYPES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "field_schema": [
            {"key": "new_contract_start", "label": "Дата начала нового контракта", "type": "date", "required": False},
            {"key": "new_contract_end", "label": "Новая дата конца контракта", "type": "date", "required": False},
            {"key": "new_contract_number", "label": "Номер нового контракта", "type": "text", "required": False},
            {"key": "new_contract_years", "label": "Срок контракта (лет)", "type": "number", "required": False},
        ],
        "filename_pattern": "Приказ_№{order_number}_{order_type_code}_{last_name}_{initials}.docx",
        "letter": "к",
    },
    {
        ...
        "field_schema": [
            {"key": "old_contract_start", "label": "Дата начала предыдущего контракта", "type": "date", "required": False},
            {"key": "old_contract_end", "label": "Дата окончания предыдущего контракта", "type": "date", "required": False},
