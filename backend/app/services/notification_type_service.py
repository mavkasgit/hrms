...
DEFAULT_NOTIFICATION_TYPES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "template_filename": None,
        "field_schema": [
            {"key": "old_contract_start", "label": "Дата начала предыдущего контракта", "type": "date", "required": True},
            {"key": "old_contract_end", "label": "Дата окончания предыдущего контракта", "type": "date", "required": True},
            ...
            {"key": "new_contract_end", "label": "Новая дата конца контракта", "type": "date", "required": True},
    ...
    {
        "code": "new_contract",
        "name": "О заключении нового контракта",
        "template_filename": None,
        "field_schema": [
            {"key": "old_contract_start", "label": "Дата начала предыдущего контракта", "type": "date", "required": True},
            {"key": "old_contract_end", "label": "Дата окончания предыдущего контракта", "type": "date", "required": True},
