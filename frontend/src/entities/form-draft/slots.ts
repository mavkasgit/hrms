...
/**
 * Кастомное window-событие: локальный черновик формы записан или очищен.
 * Попап «Черновики» слушает его, чтобы мгновенно перечитать список без
 * ожидания storage-событий (они срабатывают только в других вкладках) и таймера.
 */
export const FORM_DRAFT_CHANGED_EVENT = "hrms:form-draft-changed"
