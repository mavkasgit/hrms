...
import { openOrderPrint, downloadOrderDocx } from "@/entities/order"
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" size="sm" onClick={() => navigate("/settings/holidays")}>
...
{/* --- Vacation periods block removed --- */}
      ...
      <div className="border rounded-lg bg-card">
        <Tabs value="vacation" onValueChange={(v) => {
          if (v === "vacation") return
          navigate(`/vacations/${v}`)
        }}>
