            ...
            <div className="space-y-4">
              ...
              {preview.unmatched.length > 0 && (
                <div className="border rounded-md">
                  <div className="bg-yellow-50 dark:bg-yellow-900/40 border-b px-3 py-2 flex items-center gap-2">
              ...
              {preview.matched_preview.length > 0 && (
                <div className="border rounded-md">
                  <div className="bg-green-50 dark:bg-green-900/40 border-b px-3 py-2 flex items-center gap-2">
